"""El ordenador escoge un número aleatorio"""
import random

"""Creo la funcion selecciona_un_nivel que sera el menju del juego"""
...
"""creo la funcion que me pedira el numero de intentos que quiero tener"""
def num_intentos():
    while True:
...
"""aqui gestiono cada uno de los niveles para que me pidan distintos numeros en cada uno y el programa escoja numeros en distintos rango (del 0 al 99 del 0 al 999...)dependiendo del nivel que se escoja"""
